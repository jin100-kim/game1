...
namespace McpUnity.Unity
{
    ...
    public class McpUnityServer : IDisposable
    {
        ...
        private McpUnityServer()
        {
            ...
            {
                McpLogger.LogInfo("MCP Unity server disabled while running in batch mode or building a player.");
                return;
            }
        ...
        public void StartServer()
        {
            if (BuildPipeline.isBuildingPlayer)
            {
                McpLogger.LogInfo("Server startup skipped: Unity is building a player.");
                return;
            }
        ...
        {
            if (Application.isBatchMode || BuildPipeline.isBuildingPlayer || _instance == null) return;

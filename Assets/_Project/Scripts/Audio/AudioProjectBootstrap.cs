    ...
    internal static class AudioProjectBootstrap
    {
            ...
            AudioMixerGroup uiGroup)
        {
            return new List<AudioCueCatalog.Entry>
            {
                ...
                CreateEntry(AudioCueId.XpPickup, "Assets/_Project/Audio/Sfx/system_xp_pickup.mp3", AudioBus.Sfx, sfxGroup ?? masterGroup, 0.96f, 0.02f, 0.01f, 0f, 4, false),
                ...
                CreateEntry(AudioCueId.WeaponBfSword, "Assets/_Project/Audio/Sfx/weapon_bfsword_swing.mp3", AudioBus.Sfx, sfxGroup ?? masterGroup, 0.88f, 0.02f, 0.06f, 0f, 2, false),
